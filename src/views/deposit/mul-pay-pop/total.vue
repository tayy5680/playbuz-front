...
<div class="deposit-total__container">
    ...
    >
      ...
      >
        <img
          ...
          :src="require('./images/i_money_less.svg')"
        />
      </div>
      <input
      ...
      >
        <img
          ...
          :src="require('./images/i_money_add.svg')"
        />
      </div>
    </div>
  </div>
  ...
  >
    ...
    <div class="deposit-total__final">
      <span
        :class="tw([
          'text-[12px]',
        ])"
